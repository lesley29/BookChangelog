...
namespace BookChangelog.API.Infrastructure.Migrations
{
    ...
    [Migration("20220403181727_AddChangeDateTimeGeneration")]
    partial class AddChangeDateTimeGeneration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookChangelog.API.Models.BookAuthor", b =>
                {
            ...
            modelBuilder.Entity("BookChangelog.API.Models.BookChangeHistory", b =>
                {
                    b.HasOne("BookChangelog.API.Models.Book", "Book")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_book_change_history_books_book_id");
